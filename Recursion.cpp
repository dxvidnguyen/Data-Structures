// Name: David Nguyen
// File: p10Recursion.cpp
// Date: 03/30/20 - 05/22/20
// Description:Implement and test the following
//  - Merge Sort
//  - Binary Search (Iterative & Recursive)
//  - Factorial (Iterative and Recursive)
//  - Triangle (Iterative and Recursive)
//  - Compound Interest (Iterative and Recursive)
...
public:
    ...
    int triangleRecursive(int num)
    {
        ...
        // for triangle(4), return (4 + triangle(3)) = return (6+4) = return 10
        if (num ==1)
            return 1;
        else
    ...
    {
        // assumes that 1) guess is b/t upper and lower limit
        //              2) numToGuess is b/t upper and lower limit
        while (true)
        {
            if (guess == numToGuess) {
...
int main()
{
    ...
    cout << "\nCompound Interest Iteratively: ";
    rec->compoundInterestIterative(200.00, 5, 20);

    cout << "\nCompound Interest Recursively: \n ";
